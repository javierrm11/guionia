    ...
    <div className="flex flex-1 flex-col gap-6 p-4 lg:mx-auto lg:w-full lg:max-w-3xl lg:p-8">
      <section className="flex flex-col gap-3">
        ...
        <p className="text-caption text-text-disabled">
          Solo como referencia manual — no genera recordatorios ni aparece en el
          dashboard.
        </p>

        <div className="flex flex-col rounded-md bg-bg-primary p-4 shadow-sm lg:p-5">
                  ...
                  {entradas.length > 0 ? (
                    <div className="flex flex-col">
                      {entradas.map((entrada, entradaIndex) => {
                        const plataforma =
                          entrada.plataforma as Plataforma | null;
                        const Icon = plataforma
                          ? PLATAFORMA_ICON[plataforma]
                          : FileText;
                        const tono = plataforma
